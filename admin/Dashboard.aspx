<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="wellweb.admin.WebForm1" %>
...
<div class="row">
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize">Donated</p>
      <h4 class="mb-0"><asp:Label ID="Label1" runat="server" Text=""></asp:Label></h4>
    </div>
  </div>
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      ...
      <h4 class="mb-0"><asp:Label ID="Label2" runat="server" Text=""></asp:Label></h4>
    </div>
  </div>
