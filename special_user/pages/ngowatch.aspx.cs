...
{
    public partial class ngowatch : System.Web.UI.Page
    {
        ...
        private List<CardData> FetchCardDataFromMySQL()
        {
            ...
            string query = "SELECT id, ngoname, des FROM ngo"; // Replace with your query
            ...
            using (MySqlConnection connection = new MySqlConnection(ConfigurationManager.ConnectionStrings["LocalMysql"].ConnectionString))
            {
                ...
                while (reader.Read())
                {
                    CardData card = new CardData
                    {
                        ...
                        Name = reader["ngoname"].ToString(),
                        Address = reader["des"].ToString()
                    };
