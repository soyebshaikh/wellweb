<%@ Page Title="" Language="C#" MasterPageFile="~/seller/Site1.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="wellweb.seller.login" %>
 ...
 <div class="row toplinkbar">
                    ...
                    <div class="col-xl-4">
                            <div class="toplinks">
                               ...
                               <a href="ngologin.aspx">NGO Login</a>
                               <a href="login.aspx">Shop Login</a>
...
<div class="login-page">
    ...
    <div class="form">
      ...
      <form  runat=server>
        ...
        <p class="message">Not registered? <a href="shopregistration.aspx">Create an account</a></p>
      </form>
    </div>
  </div>
  <br/>
